...
namespace MaikeBing.EntityFrameworkCore.Storage
{
    /// <summary>
    ...
    ///     <see
    ///         cref="LiteDBDbContextOptionsExtensions.UseLiteDB{TContext}(DbContextOptionsBuilder{TContext},string,System.Action{Infrastructure.LiteDBDbContextOptionsBuilder})" />
    /// </summary>
    public sealed class LiteDBDatabaseRoot
    {
        /// <summary>
        ///     <para>
