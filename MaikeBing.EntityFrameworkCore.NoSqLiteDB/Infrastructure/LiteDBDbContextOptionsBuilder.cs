...
namespace MaikeBing.EntityFrameworkCore.Infrastructure
{
    ...
    ///         <see
    ///             cref="LiteDBDbContextOptionsExtensions.UseLiteDB(DbContextOptionsBuilder, string, System.Action{LiteDBDbContextOptionsBuilder})" />
    ...
    public class LiteDBDbContextOptionsBuilder
    {
        ...
        public LiteDBDbContextOptionsBuilder([NotNull] DbContextOptionsBuilder optionsBuilder)
        {
